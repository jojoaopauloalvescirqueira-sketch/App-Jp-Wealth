...
# (ALD-03 S1/S2/S3): carimbo v5 e a colecao do ledger criada vazia. Derivar isso aqui,
...
FIXTURE = {**FIXTURE, "schemaVersion": 5, "transactions": []}
    ...
    try:
        with sync_playwright() as pw:
            ...
            def c3():
                ...
                if not (compat["readOnly"] is True and compat["storedSchemaVersion"] == 6):
            ...
            def c4():
                for rotulo, agregado in (("v2", FIXTURE), ("v3 (future-schema)", FUTURO)):
                    ...
                    vazio = {"schemaVersion": 5, "reportingCurrency": "BRL",
            ...
            def c14():
                ...
                if igual(r["memoria"], {"schemaVersion": 5, "reportingCurrency": "BRL",
