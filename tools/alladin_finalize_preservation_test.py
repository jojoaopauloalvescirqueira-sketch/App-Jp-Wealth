...
# (ALD-03 S1/S2/S3/S4): carimbo v6 e a colecao do ledger criada vazia. Derivar isso aqui,
...
FIXTURE = {**FIXTURE, "schemaVersion": 6, "transactions": []}
...
def abrir(browser, url):
    # QA-D1: Service Worker BLOQUEADO. Boota o app real e recarrega; sem bloquear
    # o SW, o updateFxRates do boot escapa do page.route e escreve no disco,
    # contaminando as comparacoes de preservacao. O SW tem suite propria.
    ...
    try:
        with sync_playwright() as pw:
            ...
            def c3():
                ...
                if not (compat["readOnly"] is True and compat["storedSchemaVersion"] == 7):
            ...
            def c4():
                for rotulo, agregado in (("v2", FIXTURE), ("v3 (future-schema)", FUTURO)):
                    ...
                    vazio = {"schemaVersion": 6, "reportingCurrency": "BRL",
            ...
            def c14():
                ...
                if igual(r["memoria"], {"schemaVersion": 6, "reportingCurrency": "BRL",
