...
preflight, estrutura, diff-check, teste do frescor de contexto), **standard** (34 —
...
as três do Alladin e o protocolo de geração da base em Chromium real) e **full** (45 verificações, incluindo segurança de importação/XSS, senha de
